    ...
    <section id="blog" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-12">
          ...
          <div className="text-blue-600 font-medium flex items-center opacity-75 pointer-events-none">
            View All Articles
          ...
          {blogPosts.map((post) => (
            <article key={post.id} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <div className="text-blue-600 font-medium inline-flex items-center opacity-75">
                  Read More
